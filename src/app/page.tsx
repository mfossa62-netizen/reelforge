    ...
    <div className="flex items-center justify-center h-screen bg-zinc-950 text-white p-6">
      <div className="text-center space-y-4 max-w-md">
        ...
        <p className="text-zinc-400 text-sm leading-relaxed">
          The full editor is being restored. Please wait about 1 minute, then hard-refresh this page.
        </p>
        <p className="text-zinc-500 text-xs">Video export is also being added.</p>
      </div>
    </div>
  );
}
